export const darkTheme = {
  // Base colors - Deep blue-gray backgrounds inspired by Apple Maps
  'bg-primary': '#1C1C1E',            // Dark blue-gray base
  'bg-secondary': '#2C2C2E',          // Slightly lighter blue-gray
  'bg-tertiary': '#3A3A3C',          // Elevated surface color
  
  // Text colors - High contrast for legibility
  'text-primary': '#FFFFFF',          // Pure white for primary text
  'text-secondary': 'rgba(255, 255, 255, 0.85)', // Clearer secondary text
  'text-tertiary': 'rgba(255, 255, 255, 0.65)',  // Subtle tertiary
  
  // Action colors - Apple Maps blue accent
  'action-primary': '#0A84FF',        // SF blue, unchanged
  'action-primary-hover': '#0070E0',  // Slightly darker on hover
  'action-primary-light': 'rgba(10, 132, 255, 0.15)', // Increased glow opacity
  'action-primary-border': 'rgba(10, 132, 255, 0.35)', // Stronger borders
  
  // Button colors - More pronounced gradients
  'button-primary': 'linear-gradient(180deg, #0A84FF 0%, #0070E0 100%)',
  'button-primary-hover': 'linear-gradient(180deg, #0070E0 0%, #005CC8 100%)',
  'button-secondary': '#2C2C2E',      // Matching secondary background
  'button-secondary-hover': '#3A3A3C', // Matching tertiary
  'button-text': '#FFFFFF',
  'button-text-muted': 'rgba(255, 255, 255, 0.85)',
  
  // Interactive elements - Crisper states
  'interactive-text': '#FFFFFF',
  'interactive-hover': '#0A84FF',
  'interactive-muted': 'rgba(255, 255, 255, 0.65)',
  
  // Accent colors - Apple Maps style accents
  'accent-primary': '#0A84FF',        // Primary blue
  'accent-secondary': '#32D74B',      // SF green for success states
  'accent-tertiary': '#64D2FF',       // Light blue highlight
  'accent-muted': 'rgba(10, 132, 255, 0.18)',
  'accent-soft': 'rgba(50, 215, 75, 0.18)',
  
  // Borders - More defined edges
  'border-primary': 'rgba(255, 255, 255, 0.15)', // Increased contrast
  'border-secondary': 'rgba(255, 255, 255, 0.08)',
  
  // Status colors - SF system colors
  ...
  'shadow-sm': '0 2px 4px rgba(0, 0, 0, 0.6), 0 1px 3px rgba(0, 0, 0, 0.3)',
  'shadow-md': '0 4px 6px rgba(0, 0, 0, 0.6), 0 2px 6px rgba(0, 0, 0, 0.3)',
  'shadow-lg': '0 8px 12px rgba(0, 0, 0, 0.6), 0 4px 8px rgba(0, 0, 0, 0.3)',
  
  // Focus states - Clearer focus indicators
  'focus-ring': 'rgba(10, 132, 255, 0.7)',
  'focus-ring-offset': '#1C1C1E',

  // Modal and overlay colors - More pronounced blur effects
  'modal-backdrop': 'rgba(0, 0, 0, 0.6)',
  'modal-backdrop-filter': 'blur(24px)',
  'modal-bg': '#2C2C2E',
  'modal-border': 'rgba(255, 255, 255, 0.1)',
  
  // Surface overlays - Refined interaction states
  'overlay-hover': 'rgba(255, 255, 255, 0.03)',
  'overlay-active': 'rgba(255, 255, 255, 0.05)',
  'overlay-raised': 'rgba(255, 255, 255, 0.08)'
};
